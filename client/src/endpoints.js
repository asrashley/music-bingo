...
export const getUsersListURL = `${apiServerURL}/users`;
export const modifyUsersURL = `${apiServerURL}/users`;
export const getGamesURL = `${apiServerURL}/games`;
export const getGameDetailURL = (gamePk) => `${apiServerURL}/games/${gamePk}`;
export const modifyGameURL = (gamePk) => `${apiServerURL}/games/${gamePk}`;
