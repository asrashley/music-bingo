  ...
  return (
    <div className="privacy-policy">
      ...
      <ul>
        ...
        <li>Use or view our website via your browser's cookies and tokens.</li>
      </ul>
      ...
      <p>
        Our Company will keep your account details entil you request their removal.
        </p>
      <h3>Marketing</h3>
      <p>
      ...
      <p>
        Cookies and tokens are text files placed on your computer to collect standard Internet log
        information and visitor behavior information. When you visit this website, we may collect
        information from you automatically through cookies or tokens.
        </p>
      <p>For further information, visit <a href="https://allaboutcookies.org">allaboutcookies.org</a>.</p>
      <h3>How do we use cookies and tokens?</h3>
      <p>
        Our Company uses cookies and tokens in a range of ways to improve your experience on this
        website, including:
        </p>
      <ul>
      ...
      <p>
        ...
        page.This privacy policy was last updated on 26 May 2020.
        </p>
